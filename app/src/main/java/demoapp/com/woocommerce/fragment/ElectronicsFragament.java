...
public class ElectronicsFragament extends Fragment {
    //Defining Variables
    ...
    public static ElectronicsFragament newInstance() {
        ElectronicsFragament fragment = new ElectronicsFragament();
        fragment.setRetainInstance(true);
        return fragment;
    }

    public ElectronicsFragament() {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        if (hasConnection(getActivity())) {
            new ElectronicsFragament.CategoryAsyncTask().execute();
        } else {
